...
- Papel administrativo é `SuperRoot` (coluna `superusuario`). Módulos existentes: autenticação (local + LDAP), perfil institucional (revalidação a cada 30 dias), usuários, setores, ACL e diretórios LDAP.
