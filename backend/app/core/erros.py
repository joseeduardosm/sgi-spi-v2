...
MENSAGENS_VALIDACAO = {
    ...
    "decimal_type": "deve ser um número",
    "decimal_max_places": "deve ter no máximo {decimal_places} casa(s) decimal(is)",
    "decimal_max_digits": "deve ter no máximo {max_digits} dígito(s)",
